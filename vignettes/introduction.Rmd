...
**muti** computes the mutual information $(\mathrm{MI})$ contained in two vectors of discrete random variables. **muti** was developed with time series analysis in mind, but there is nothing tying the methods to a time index _per se_.
